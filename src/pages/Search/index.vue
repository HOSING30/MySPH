      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <!-- 属性的面包屑 -->
            <li class="with-x" v-for="(arrtrValue,index) in searchParams.props" :key="index">
              {{ arrtrValue.split(':')[1] }}<i @click="removeAttr(index)">×</i>
            </li>
          </ul>
        </div>
